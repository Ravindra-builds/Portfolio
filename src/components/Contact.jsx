  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-t from-gray-900 to-gray-950">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 slideRight">Get In Touch</h2>
        <div className="w-20 h-1 bg-blue-500 mx-auto rounded-full mb-8"></div>

        <p className="text-md text-gray-300 mb-12 max-w-2xl mx-auto slideLeft">
          I'm currently looking for new opportunities. Whether you have a question or just want to say hi, I'll try my best to get back to you!
        </p>

        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 md:p-12 shadow-2xl slideUp">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="flex flex-col items-center">
              ...
              <a href="mailto:yadavravindra7292@gmail.com" className="text-gray-400 hover:text-blue-400 transition-colors">
                yadavravindra7292@gmail.com
              </a>
            </div>
          ...
          <div className="flex justify-center gap-6">
            ...
            <a
              href="https://x.com/YadavRavin7292"
              target="_blank"
              rel="noopener noreferrer"
          ...
          <div className="mt-12 pt-8 border-t border-gray-800">
            <a
              href="mailto:yadavravindra7292@gmail.com"
